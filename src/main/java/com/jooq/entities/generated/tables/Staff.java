...
public class Staff extends TableImpl<StaffRecord> {
    ...
    private static final long serialVersionUID = 1434219641;
     ...
     */
    public final TableField<StaffRecord, Short> ADDRESS_ID = createField(DSL.name("address_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");
     ...
     */
    public final TableField<StaffRecord, Short> STORE_ID = createField(DSL.name("store_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");
