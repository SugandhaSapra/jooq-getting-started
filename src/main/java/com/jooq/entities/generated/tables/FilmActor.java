...
public class FilmActor extends TableImpl<FilmActorRecord> {
    ...
    private static final long serialVersionUID = 979699310;
     ...
     */
    public final TableField<FilmActorRecord, Short> ACTOR_ID = createField(DSL.name("actor_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");

    /**
     * The column <code>public.film_actor.film_id</code>.
     */
    public final TableField<FilmActorRecord, Short> FILM_ID = createField(DSL.name("film_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");
