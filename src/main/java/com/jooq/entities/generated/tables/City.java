...
public class City extends TableImpl<CityRecord> {
    ...
    private static final long serialVersionUID = -1758416382;
     ...
     */
    public final TableField<CityRecord, Short> COUNTRY_ID = createField(DSL.name("country_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");
    ...
    public List<ForeignKey<CityRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<CityRecord, ?>>asList(Keys.CITY__FK_CITY);
    }
