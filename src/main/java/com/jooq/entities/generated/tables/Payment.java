...
public class Payment extends TableImpl<PaymentRecord> {
    ...
    private static final long serialVersionUID = -2041122015;
     ...
     */
    public final TableField<PaymentRecord, Short> CUSTOMER_ID = createField(DSL.name("customer_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");

    /**
     * The column <code>public.payment.staff_id</code>.
     */
    public final TableField<PaymentRecord, Short> STAFF_ID = createField(DSL.name("staff_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.IDX_FK_CUSTOMER_ID, Indexes.IDX_FK_RENTAL_ID, Indexes.IDX_FK_STAFF_ID);
    }
