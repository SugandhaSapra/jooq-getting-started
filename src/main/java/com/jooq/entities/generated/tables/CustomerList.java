...
import com.jooq.entities.generated.tables.records.CustomerListRecord;
...
public class CustomerList extends TableImpl<CustomerListRecord> {
    ...
    private static final long serialVersionUID = -487815579;
     ...
     */
    public final TableField<CustomerListRecord, Short> SID = createField(DSL.name("sid"), org.jooq.impl.SQLDataType.SMALLINT, this, "");
