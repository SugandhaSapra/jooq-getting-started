...
public class Inventory extends TableImpl<InventoryRecord> {
    ...
    private static final long serialVersionUID = 1558172633;
     ...
     */
    public final TableField<InventoryRecord, Short> FILM_ID = createField(DSL.name("film_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");

    /**
     * The column <code>public.inventory.store_id</code>.
     */
    public final TableField<InventoryRecord, Short> STORE_ID = createField(DSL.name("store_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");
