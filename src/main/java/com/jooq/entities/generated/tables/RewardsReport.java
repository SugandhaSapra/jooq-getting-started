...
public class RewardsReport extends TableImpl<RewardsReportRecord> {
    ...
    private static final long serialVersionUID = 58705838;
     ...
     */
    public final TableField<RewardsReportRecord, Short> STORE_ID = createField(DSL.name("store_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");
     ...
     */
    public final TableField<RewardsReportRecord, Short> ADDRESS_ID = createField(DSL.name("address_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");
