...
public class FilmCategory extends TableImpl<FilmCategoryRecord> {
    ...
    private static final long serialVersionUID = -43316475;
     ...
     */
    public final TableField<FilmCategoryRecord, Short> FILM_ID = createField(DSL.name("film_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");

    /**
     * The column <code>public.film_category.category_id</code>.
     */
    public final TableField<FilmCategoryRecord, Short> CATEGORY_ID = createField(DSL.name("category_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");
