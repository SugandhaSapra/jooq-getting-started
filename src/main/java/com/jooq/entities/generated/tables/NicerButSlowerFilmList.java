...
import com.jooq.entities.generated.tables.records.NicerButSlowerFilmListRecord;
...
public class NicerButSlowerFilmList extends TableImpl<NicerButSlowerFilmListRecord> {
    ...
    private static final long serialVersionUID = -788269885;
     ...
     */
    public final TableField<NicerButSlowerFilmListRecord, Short> LENGTH = createField(DSL.name("length"), org.jooq.impl.SQLDataType.SMALLINT, this, "");

    /**
     * The column <code>public.nicer_but_slower_film_list.rating</code>.
     */
    public final TableField<NicerButSlowerFilmListRecord, MpaaRating> RATING = createField(DSL.name("rating"), org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.jooq.entities.generated.enums.MpaaRating.class), this, "");
