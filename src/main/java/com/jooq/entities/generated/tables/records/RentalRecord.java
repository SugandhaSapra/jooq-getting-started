...
public class RentalRecord extends UpdatableRecordImpl<RentalRecord> implements Record7<Integer, LocalDateTime, Integer, Short, LocalDateTime, Short, LocalDateTime> {

    private static final long serialVersionUID = 1564297989;
    ...
    @Override
    public Row7<Integer, LocalDateTime, Integer, Short, LocalDateTime, Short, LocalDateTime> valuesRow() {
    ...
    @Override
    public RentalRecord values(Integer value1, LocalDateTime value2, Integer value3, Short value4, LocalDateTime value5, Short value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RentalRecord(Integer rentalId, LocalDateTime rentalDate, Integer inventoryId, Short customerId, LocalDateTime returnDate, Short staffId, LocalDateTime lastUpdate) {
        super(Rental.RENTAL);
