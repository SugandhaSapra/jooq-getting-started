...
public class Store extends TableImpl<StoreRecord> {
    ...
    private static final long serialVersionUID = -1458768568;
     ...
     */
    public final TableField<StoreRecord, Short> MANAGER_STAFF_ID = createField(DSL.name("manager_staff_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");

    /**
     * The column <code>public.store.address_id</code>.
     */
    public final TableField<StoreRecord, Short> ADDRESS_ID = createField(DSL.name("address_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");
