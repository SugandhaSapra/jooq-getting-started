...
public class Rental extends TableImpl<RentalRecord> {
    ...
    private static final long serialVersionUID = 349243025;
     ...
     */
    public final TableField<RentalRecord, Short> CUSTOMER_ID = createField(DSL.name("customer_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");
     ...
     */
    public final TableField<RentalRecord, Short> STAFF_ID = createField(DSL.name("staff_id"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");
    ...
    public List<ForeignKey<RentalRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<RentalRecord, ?>>asList(Keys.RENTAL__RENTAL_INVENTORY_ID_FKEY, Keys.RENTAL__RENTAL_CUSTOMER_ID_FKEY, Keys.RENTAL__RENTAL_STAFF_ID_KEY);
    }
