...
import com.jooq.entities.generated.tables.records.FilmListRecord;
...
public class FilmList extends TableImpl<FilmListRecord> {
    ...
    private static final long serialVersionUID = 1947615459;
     ...
     */
    public final TableField<FilmListRecord, Short> LENGTH = createField(DSL.name("length"), org.jooq.impl.SQLDataType.SMALLINT, this, "");

    /**
     * The column <code>public.film_list.rating</code>.
     */
    public final TableField<FilmListRecord, MpaaRating> RATING = createField(DSL.name("rating"), org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.jooq.entities.generated.enums.MpaaRating.class), this, "");
