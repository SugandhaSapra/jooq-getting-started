...
@Configuration
@EnableJpaRepositories(basePackages = "com.jooq.repository", transactionManagerRef = "jpaTransactionManager")
@PropertySource(value = { "classpath:application.properties" })
@EnableTransactionManagement
public class JPAConfig {
    private static final String[] ENTITYMANAGER_PACKAGES_TO_SCAN = { "com.jooq.entities" };
